...
ActiveRecord::Schema.define(version: 2022_01_27_230059) do
  ...
  create_table "audiences", force: :cascade do |t|
    ...
    t.index ["course_id"], name: "index_audiences_on_course_id"
    t.index ["user_id", "course_id"], name: "index_audiences_on_user_id_and_course_id", unique: true
  ...
  add_foreign_key "audiences", "courses"
